...
class _CategorieListState extends State<CategorieList> {
  ...
  performCategorieUpdate(int index, Categorie categorie) async {
    String result = await ServiceBase.update(index, categorie);
  ...
  _performCategorieDelete(int index,Categorie categorie) async{
    String result = await ServiceBase.delete(index,categorie);
  }

  showData(int index, BuildContext context) async {
    Categorie categorie = (await ServiceBase.getData<Categorie>(
        index, (jsonData) => Categorie.fromJson(jsonData)));
    if (!context.mounted || categorie == null) {
      return Error();
    }
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    ...
                    _performCategorieDelete(index,categorie); // Call your deleteCategorie function
                    Navigator.of(context)
                        .pop();
                  },
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  _performCategorieCreation(Categorie categorie) async {
    String result = await ServiceBase.create(categorie);
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(result),
      behavior: SnackBarBehavior.floating,)
    );
  }
